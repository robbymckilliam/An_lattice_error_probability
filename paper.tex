...
\begin{abstract}
We consider the root lattice $A_n$ and derive explicit formulae for the moments of its Voronoi cell.  These formulae
...
\begin{align}
P_C &\geq P_C(\Lambda) = \lim_{\abs{\calC}\rightarrow \infty}
 \frac{1}{\abs{\calC}} \sum_{\cbf\in \calC} \prob( \cbf + \wbf \in
\vor(\Lambda) + \cbf )  \nonumber \\
...
We can make further simplifications.  Letting $t = x_1 - x_2$ and $y = x_1 + 1/2$ and changing variables,
\[
