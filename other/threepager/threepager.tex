...
% \end{array} \right].
% \]
In two dimensions $A_2$ is the hexagonal lattice (Figure~\ref{fig:hexlatfig}), and in three dimension $A_3$ is the body centered cubic lattice~\cite[p. 108]{SPLAG}.  These are the densest known sphere packings in dimensions two and three.
